...
<body dir='rtl' class="w3-light-grey" onload="initApp();">
...
<div class="w3-container w3-top w3-black w3-large w3-padding" style="z-index:4">
  ...
  <b style="margin-right:350px"><?php echo($CF['app_name']); ?></b>
  <span class="w3-right">
...
?>
	...
	<a href="index.php?action=contacts" class="w3-padding<?php if($ds == 'contacts') echo($dc); ?>">
		<i class="fa fa-users fa-fw"></i> اشخاص
	</a>
...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-right:250px;margin-top:43px;">
