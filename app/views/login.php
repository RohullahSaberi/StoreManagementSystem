...
<html>
	...
	<body dir='rtl' style="background: url('res/background.jpg') no-repeat center fixed; background-size: cover;">
			...
			<div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:400px">
			  ...
			  <form class="w3-container" method="post" action="index.php">
				<div class="w3-section">
				  ...
				  <input class="w3-input w3-border" type="password" placeholder="" name="login_password" required>
